...
import AddCredentialSlider from './src/keyring-theme/components/AddCredentialSlider'
import EmptyList from './src/keyring-theme/components/EmptyList'
import HomeFooterView from './src/keyring-theme/components/HomeFooterView'
import HomeHeaderView from './src/keyring-theme/components/HomeHeaderView'
import PersonCredential from './src/keyring-theme/features/person-flow/screens/PersonCredential'
...
export class AppContainer implements Container {
  ...
  public init(): Container {
    ...
    this._container.registerInstance(TOKENS.CONFIG, {
      ...
      settings: [
        /* Help section commented out — re-enable when help actions are wired up
        {
          ...
          data: [
            {
              title: this.t('Settings.HelpUsingKeyring'),
              accessibilityLabel: this.t('Settings.HelpUsingKeyring'),
              testID: testIdWithKey('HelpUsingKeyRing'),
              onPress: () => {},
            },
            {
        ...
        */
        {
          ...
          data: [
            ...
            {
              title: this.t('Settings.AboutThisApp'),
              accessibilityLabel: this.t('Settings.AboutThisApp'),
              testID: testIdWithKey('AboutThisApp'),
              onPress: () => this.navigate(Stacks.SettingStack as never, { screen: Screens.About } as never),
            },
          ],
        },
      ],
      ...
      showPreface: false, // Welcome content moved to onboarding carousel
    ...
    // Initialize VRC module (credential display handlers, localization, container registration)
