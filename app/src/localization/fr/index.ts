...
const translation = {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "Pour continuer à utiliser la fonction de scan de Keyring, veuillez activer les autorisations de la caméra.",
    "Allow": "Autoriser",
    "OpenSettings": "Ouvrir les paramètres",
  },
  "Biometry": {
    "Toggle": "Activer/Désactiver la biométrie",
    "EnabledText1": "Connectez-vous avec les données biométriques de votre téléphone plutôt que votre code PIN Keyring.",
  ...
  "Onboarding": {
    // Page 1: Welcome
    "WelcomeHeading": "Bienvenue sur Keyring",
    "WelcomeParagraph": "Keyring vous donne le contrôle de votre identité numérique. Vous décidez ce que vous partagez et en qui vous avez confiance.\n\nAvec ce portefeuille, vous pouvez:\n• Recevoir et partager des identifiants d'organisations\n• Créer des connexions de confiance avec des personnes que vous connaissez\n• Construire votre propre réseau de relations vérifiées",
    "LearnMoreLink": "En savoir plus sur le projet Keyring",
    // Page 2: Credentials
    "CredentialsHeading": "Recevoir des identifiants d'organisations",
    "CredentialsParagraph": "Les identifiants sont des versions numériques de documents que vous utilisez déjà — comme les pièces d'identité, les certifications et les adhésions.\n\nLes organisations peuvent émettre des identifiants directement dans votre portefeuille. Vous pouvez ensuite les partager avec d'autres qui peuvent vérifier leur authenticité.\n\nVos identifiants restent sur votre appareil, sous votre contrôle.",
    // Page 3: Connections
    ...
    "DifferentWalletParagraph": "Contrairement aux autres portefeuilles numériques, Keyring vous aide à prouver votre identité en personne ou en ligne en stockant et en utilisant des informations d'identification numériques émises par les services participants.\n\nInteragissez en toute confiance avec les individus et les organisations que vous avez confiance.",
    ...
    "PrivateConfidentialParagraph": "Votre vie privée est importante.\n\nKeyring ne sait pas quand vous utilisez des identifiants numériques, à moins que vous n'interagissiez avec eux. Aucune analyse n'est enregistrée.\n\nVous approuvez chaque utilisation de vos identifiants numériques et ne fournissez que les informations nécessaires.",
  },
  "Preface": {
    "Paragraph1": "La plupart des gens n'auront pas besoin de Keyring car très peu de titres numériques sont actuellement disponibles.",
    "Link1": "Voir où vous pouvez utiliser Keyring",
    "Paragraph2": "Si Keyring ne correspond pas à ce que vous recherchez, mais que vous êtes curieux, consultez notre rubrique",
    "Link2": "Présentation de Keyring",
  },
  "Screens": {
    "Onboarding": "Keyring",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "Vous ne pouvez pas accéder aux services en utilisant Keyring ou recevoir des informations d'identification jusqu'à ce que vous soyez de nouveau en ligne.\n\nVeuillez vérifier votre connexion internet.",
  },
  "Tour": {
    "GuideTitle": "Bienvenue sur Keyring",
    "WouldYouLike": "Souhaitez vous obtenir des conseils sur l'utilisation de Keyring ?",
  ...
  "Settings": {
    ...
    "PlayWithKeyring": "Jouer avec Keyring",
    "HelpUsingKeyring": "Aide à l'utilisation de Keyring",
  ...
  "Developer": {
    ...
    "EnableDidCommV2": "Activer DIDComm v2 (expérimental)",
  },
  "Tips": {
    "Header": "Conseils",
    "GettingReady": "Préparation de votre portefeuille en cours...",
    "Tip1": "Pour plus de sécurité, Keyring verrouille l'application après 5 minutes d'inactivité.",
  ...
  "RemoteLogging": {
    ...
    "CollectionNoticePart2": " pendant qu'il est activé.\n\nLe dépannage à distance se désactive après 1 heure. Les informations collectées sont supprimées après 3 jours.\n\nCes informations sont collectées uniquement à des fins de support client et de dépannage.\n\nPour plus d'informations, y compris qui contacter, lisez la",
    "CollectionNoticeLink": "Politique de confidentialité.",
    "CollectionNoticeWarning": "Activez le dépannage à distance uniquement si vous avez d'abord contacté la ligne de support et qu'un agent de support vous a demandé de l'activer. Ils ne vous contacteront jamais en premier. Vous n'êtes jamais obligé de l'activer.",
  ...
  "AppUpdate": {
    "Heading": "Update Keyring to the latest version (FR)",
    "Body": "Keyring was updated with new improvements. Update your app now to enjoy the latest features and enhancements. (FR)"
  },
  "Help Centre": {
    "Title": "Centre d'aide",
  }
