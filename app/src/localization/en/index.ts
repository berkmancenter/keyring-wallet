...
const translation = {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the Keyring scan feature, please allow camera permissions.",
    "Allow": "Allow",
    "OpenSettings": "Open settings",
  },
  "Biometry": {
    "Toggle": "Toggle Biometric Unlock",
    "EnabledText1": "Use Face ID or fingerprint to open your Keyring instead of your PIN.",
    "EnabledText1Bold": "you will need to use biometrics to open your Keyring.",
    "EnabledText2": "This means all fingerprint and facial data added on this phone can be used to access your Keyring.",
    "EnabledText3": "Anyone who can access your phone with biometrics can access your Keyring.",
  ...
  "Credentials": {
    ...
    "EmptyList": "No credentials yet",
    "EmptyListDescription": "Your digital credentials will appear here once you receive them. Start by scanning a QR code or accepting an invitation.",
    "AddFirstCredential": "Add Credential"
  },
  "Onboarding": {
    // Page 1: Welcome
    "WelcomeHeading": "Welcome",
    "WelcomeParagraph": "Take control of your digital identity. Receive credentials, build trusted connections, and decide what to share.",
    "LearnMoreLink": "Learn more about the Keyring project",
    // Page 2: Credentials
    "CredentialsHeading": "Digital Credentials",
    "CredentialsParagraph": "Receive IDs, certifications, and memberships directly to your wallet. Share them securely — always under your control.",
    // Page 3: Connections
    ...
    "DifferentWalletParagraph": "Unlike other digital wallets, Keyring helps you prove who you are online by storing and using digital credentials issued by participating services.\n\nInteract with confidence with individuals and organizations you trust.",
  ...
  "Preface": {
    "Paragraph1": "Most people will not have a need for Keyring because very few digital credentials are currently available.",
    "Link1": "See where you can use Keyring",
    "Paragraph2": "If Keyring isn't what you're looking for but you're curious, check out our",
    "Link2": "Keyring showcase",
  },
  "Screens": {
    "Onboarding": "Keyring",
    "Terms": "Terms of Use",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "You're unable to access services using Keyring or receive credentials until you're back online.\n\nPlease check your internet connection."
  },
  "Tour": {
    "GuideTitle": "Welcome to Keyring",
    "WouldYouLike": "Would you like some guidance on how to use Keyring?",
  ...
  "Settings": {
    ...
    "PlayWithKeyring": "Play with Keyring",
    "HelpUsingKeyring": "Help using Keyring",
  ...
  "Tips": {
    ...
    "Tip1": "For extra security, Keyring locks the app after 5 minutes of inactivity",
  ...
  "RemoteLogging": {
    ...
    "CollectionNoticeWarning": "Only turn on remote troubleshooting if you contacted the support line first and a support agent asked you to turn it on. They will never contact first. You are never required to turn it on.",
  ...
  "AppUpdate": {
    "Heading": "Update Keyring to the latest version",
    "Body": "Keyring was updated with new improvements. Update your app now to enjoy the latest features and enhancements."
  },
  "HelpCentre": {
    "Title": "Help Centre"
  },
