...
const translation = {
  ...
  "Error": {
    ...
    "ProblemDescription": "Ocorreu um erro inesperado. Reporte este erro e tente novamente.",
  },
  "Global": {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "Para continuar usando o recurso de digitalização do Keyring, permita as permissões da câmera.",
    "Allow": "Allow (PT-BR)",
  ...
  "Biometry": {
    ...
    "EnabledText1Bold": "você precisará usar biometria para abrir seu Keyring.",
    "EnabledText2": "Isso significa que todos os dados de impressão digital e facial adicionados neste telefone podem ser usados para acessar seu Keyring.",
    "EnabledText3": "Qualquer pessoa que possa acessar seu telefone com biometria pode acessar seu Keyring.",
  ...
  "Onboarding": {
    // Page 1: Welcome
    "WelcomeHeading": "Bem-vindo ao Keyring",
    "WelcomeParagraph": "O Keyring dá a você controle sobre sua identidade digital. Você decide o que compartilhar e em quem confiar.\n\nCom esta carteira, você pode:\n• Receber e compartilhar credenciais de organizações\n• Criar conexões confiáveis com pessoas que você conhece\n• Construir sua própria rede de relacionamentos verificados",
    "LearnMoreLink": "Saiba mais sobre o projeto Keyring",
    // Page 2: Credentials
    "CredentialsHeading": "Receba credenciais de organizações",
    "CredentialsParagraph": "Credenciais são versões digitais de documentos que você já usa — como identidades, certificações e associações.\n\nOrganizações podem emitir credenciais diretamente para sua carteira. Você pode então compartilhá-las com outros que podem verificar sua autenticidade.\n\nSuas credenciais permanecem no seu dispositivo, sob seu controle.",
    // Page 3: Connections
    ...
    "DifferentWalletParagraph": "Ao contrário de outras carteiras digitais, o Keyring ajuda você a provar quem você é pessoalmente ou online, armazenando e usando credenciais digitais emitidas por serviços participantes.\n\nInteraja com confiança com indivíduos e organizações que você",
    ...
    "PrivateConfidentialParagraph": "Your privacy is important.\n\nThe Applied Social Media Lab doesn't know when you use digital credentials, unless you're interacting with them. No analytics are recorded.\n\nYou approve every use of your digital credentials, and only provide the information that's needed. (PT-BR)",
  },
  "Preface": {
    "Paragraph1": "A maioria das pessoas não terá necessidade do Keyring porque muito poucas credenciais digitais estão atualmente disponíveis.",
    "Link1": "Veja onde você pode usar o Keyring",
    "Paragraph2": "Se o Keyring não for o que você está procurando, mas você está curioso, confira nossa",
    "Link2": "Apresentação do Keyring",
  },
  "Screens": {
    "Onboarding": "Keyring",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "Você não consegue acessar serviços usando o Keyring ou receber credenciais até estar online novamente.\n\nPor favor, verifique sua conexão com a internet.",
  },
  "Tour": {
    "GuideTitle": "Bem-vindo ao Keyring",
    "WouldYouLike": "Gostaria de algumas orientações sobre como usar o Keyring?",
  ...
  "Settings": {
    ...
    "PlayWithKeyring": "Jogar com Keyring",
    "HelpUsingKeyring": "Ajuda para usar o Keyring",
  ...
  "Tips": {
    ...
    "Tip1": "Para maior segurança, o Keyring bloqueia o aplicativo após 5 minutos de inatividade",
  ...
  "RemoteLogging": {
    ...
    "CollectionNoticePart2": " while it is turned on.\n\nRemote troubleshooting turns off after 1 hour. The information collected is deleted after 3 days.\n\nThis information is collected solely for the purpose of customer support and troubleshooting.\n\nFor more information, including who to contact, read the (PT-BR)",
    "CollectionNoticeLink": "Privacy Policy. (PT-BR)",
    "CollectionNoticeWarning": "Only turn on remote troubleshooting if you contacted the support line first and a support agent asked you to turn it on. They will never contact first. You are never required to turn it on. (PT-BR)",
  ...
  "AppUpdate": {
    "Heading": "Atualize o Keyring para a versão mais recente",
    "Body": "O Keyring foi atualizado com novas melhorias. Atualize seu aplicativo agora para desfrutar dos recursos e aprimoramentos mais recentes.",
  },
  "HelpCentre": {
