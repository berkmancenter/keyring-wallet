...
import { BCSCScreens, BCSCRootStackParams } from '../../types/navigators'
import SampleApiDisplay from './components/SampleApiDisplay'

type SettingsNavigationProp = StackNavigationProp<BCSCRootStackParams>
...
const Settings: React.FC = () => {
  ...
  const onPressMode = () => {
    ...
    dispatch({ type: BCDispatchAction.UPDATE_MODE, payload: [Mode.KeyRing] })
  }
  ...
  const onPressExportWallet = () => {
    navigation.navigate(BCSCScreens.ExportWallet)
  }

  const onPressImportWallet = () => {
    navigation.navigate(BCSCScreens.ImportWallet)
  }
    ...
    <TabScreenWrapper>
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.walletBackupSection}>
            <Text style={styles.walletBackupTitle}>Wallet Backup</Text>
            <View style={styles.walletBackupButtons}>
              <Button
                title={'Export Wallet'}
                accessibilityLabel={'Export Wallet'}
                buttonType={ButtonType.Secondary}
                onPress={onPressExportWallet}
              />
              <Button
                title={'Import Wallet'}
        ...
        <View style={styles.controlsContainer}>
          <View style={{ marginVertical: Spacing.md }}>
            <Button
              title={'Use Keyring Mode'}
              accessibilityLabel={'Use Keyring Mode'}
