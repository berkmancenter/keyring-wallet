...
const redirectUrlTemplate = 'keyring://bcsc/v1/dids/<did>'
// DISABLED: Person credential notification disabled for ASML wallet
...
export const showPersonCredentialSelector = (credentialDefinitionIDs: string[]): boolean => {
  // DISABLED: Person credential notification disabled for ASML wallet
  // Original logic: If we already have a trusted person credential do not show
