 ...
 *
 * Ported from bc-wallet-mobile. Prefer this over react-native's TouchableOpacity —
 * Pressable uses the modern responder system and is reliable on the New Architecture
 * (TouchableOpacity taps get dropped in some nested-list/inverted-list situations).
 *
