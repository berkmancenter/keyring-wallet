...
// This component is used outside the theme provider in many cases (e.g. the
// top-level ErrorBoundary fallback) and has style requirements the theme
// doesn't support well, so the colours are defined here (Keyring brand).
export const colors = {
  ...
  link: '#622C62', // Keyring brand purple
  primaryButton: '#622C62',
  primaryButtonDisabled: '#757575',
  primaryButtonText: '#FFFFFF',
  primaryButtonTextDisabled: '#FFFFFF',
  successIcon: '#89CE00',
  secondaryButtonBackground: '#FFFFFF',
  secondaryButtonBorder: '#622C62',
  secondaryButtonText: '#622C62',
  destructiveButton: '#D21E30', // Keyring bright crimson
