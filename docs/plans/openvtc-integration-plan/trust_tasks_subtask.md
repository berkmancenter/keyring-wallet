...
Still open: re-running `ref-08-credential-exchange`'s fixture suite through
the new port-based reference adapter (this step's own remaining "done when"
item below). See [`2026-09-02-bam.md`](./2026-09-02-bam.md)'s closing
sections for the Phase D build and the `ref-12` bug it caught (an
independently-derived `KeyAgreement` resolves to the wrong key once a real
`VidResolver` is involved), and [`2026-09-03-bam.md`](./2026-09-03-bam.md)
for this bug and the witness-over-TSP work below.
