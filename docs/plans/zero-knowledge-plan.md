...
- **B5** — A signal a client can read that the VTA and VTC operators differ (§3.5). Not designed anywhere yet. It is a candidate VTI-QN question, to raise when Z1 starts.
