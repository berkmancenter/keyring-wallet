...
| **ref-06x-cypress-stack** (planned) | Alice+Bob as Credo agents enrolled against a Cypress VTA (webvh DIDs, affinidi mediator), running the witnessed exchange on binding 0.2 + trust-tasks 0.9.0 | Closes step 3 of the build-up phasing (components proven separately by ref-04/ref-05); the spine of the Prague demo plumbing | next |
