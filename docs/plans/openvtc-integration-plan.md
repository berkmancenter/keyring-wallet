...
*Living plan for the OpenVTC infrastructure-compatibility workstream, at **Rev 24**. Supporting research (TSP/DIDComm learning notes, engineering brief) is kept out of the repo for now; ask if you want it.*
