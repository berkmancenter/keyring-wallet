...
**Version 1.21 — 2026-09-20.** A living document: every finding here was measured
...
| **F** (Farm) | 2026-09-20 | not measured — VTA REST `https://vta-keyring-al.ic3.dev` answers `/health` but exposes no version | `mediator.ic3.dev` — **older than 0.26.5**, measured by route probe, not by asking | DID hosting `dids.ic3.dev` |
